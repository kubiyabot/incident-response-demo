...
class IncidentConfig(BaseModel):
    ...
    incident_priority: IncidentPriority = Field(IncidentPriority.MEDIUM, description="Incident priority")
    ...
    # Service validation
    affected_services: Optional[str] = Field(None, description="Comma-separated list of affected services")
    
    # Communication channels
    slack_channel_id: str = Field("#incidents", description="Primary Slack channel for notifications")

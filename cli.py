...
"""
    ...
    execute_parser.add_argument("--severity", required=True, choices=["critical", "high", "medium", "low"], help="Incident severity")
    execute_parser.add_argument("--services", help="Comma-separated list of affected services")
    execute_parser.add_argument("--priority", choices=["urgent", "high", "medium", "low"], default="medium", help="Incident priority")
    ...
    export_parser.add_argument("--format", choices=["json", "yaml", "dict"], default="json", help="Export format")
    ...
    export_parser.add_argument("--title", default="Template Incident", help="Template incident title")
    export_parser.add_argument("--severity", default="medium", choices=["critical", "high", "medium", "low"], help="Template severity")
    ...
    agent_parser.add_argument("--severity", required=True, choices=["critical", "high", "medium", "low"], help="Incident severity")
    ...
    validate_parser.add_argument("--severity", required=True, choices=["critical", "high", "medium", "low"], help="Incident severity")
